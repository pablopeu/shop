...
<aside class="sidebar">
    ...
    <ul class="sidebar-menu">
        ...
        <li>
            ...
            <ul class="submenu <?php echo in_array($current_page, ['config-sitio.php', 'config-moneda.php', 'config-hero.php', 'config-carrusel.php', 'config-productos-heading.php', 'config-dashboard.php', 'config-mantenimiento.php', 'config-themes.php']) ? 'open' : ''; ?>"
