                    ...
                    <tr>
                        <td style="padding: 40px 30px;">
                            ...
                            <div style="background-color: #d1ecf1; border-left: 4px solid #17a2b8; padding: 20px; margin-bottom: 30px; border-radius: 4px;">
                                <p style="margin: 0; color: #0c5460; font-size: 15px; font-weight: 600;">
                                ...
                                <tr>
                                    <td>
                                        <table width="100%" cellpadding="8" cellspacing="0">
                                            ...
                                            <tr>
                                                <td style="color: #666666; font-size: 14px; font-weight: 600;">Número de Seguimiento:</td>
                                                <td style="color: #667eea; font-size: 14px; text-align: right; font-family: monospace; font-weight: 600;">
                                                    <?= htmlspecialchars($order['tracking_number']) ?>
                                                </td>
                                            </tr>
                                            <?php endif; ?>
                                            <?php if (isset($order['shipping_company']) && !empty($order['shipping_company'])): ?>
                                            <tr>
                                                <td style="color: #666666; font-size: 14px; font-weight: 600;">Empresa de Envío:</td>
                                                <td style="color: #333333; font-size: 14px; text-align: right;">
                                                    <?= htmlspecialchars($order['shipping_company']) ?>
                                                </td>
                                            </tr>
                                            <?php endif; ?>
                                            <tr>
                                                <td style="color: #666666; font-size: 14px; font-weight: 600;">Fecha de Envío:</td>
                                                <td style="color: #333333; font-size: 14px; text-align: right;">
                                                    <?= date('d/m/Y', strtotime($order['shipped_date'] ?? 'now')) ?>
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
                            ...
                            <div style="background-color: #fff3cd; border-left: 4px solid #ffc107; padding: 15px; margin-bottom: 30px; border-radius: 4px;">
                                <p style="margin: 0; color: #856404; font-size: 14px; line-height: 1.6;">
                                    <strong>💡 Consejo:</strong> Por favor, ten tu DNI a mano cuando recibas el paquete. El transportista puede solicitarlo para confirmar la entrega.
                                </p>
                            </div>
