<?php
/**
 * Admin - Payment Credentials Path Configuration
 * Configure where payment credentials are stored (outside webroot)
 */
...
$page_title = '🔐 Ubicación de Secretos de Pago';

// Payment credentials path file
$payment_credentials_path_file = __DIR__ . '/../.payment_credentials_path';

// Get current credentials path
$current_path = file_exists($payment_credentials_path_file)
    ? trim(file_get_contents($payment_credentials_path_file))
...
<head>
    ...
    <title>Ubicación de Secretos de Pago - Admin</title>
    <style>
        * {
            margin: 0;
            padding: 0;
    ...
    <div class="main-content">
        ...
        <div class="card">
            <div class="card-header">
                <h2>🔐 Ubicación del Archivo de Secretos de Pago</h2>
            </div>
            ...
            <form method="POST">
                <div class="form-group">
                    <label for="credentials_path">Path del archivo de credenciales de pago</label>
                ...
                <div class="info-box">
                    ...
                    <strong>Hosting cPanel:</strong> <code>/home2/uv0023/payment_credentials.json</code> (fuera de public_html)<br>
                ...
                <div class="info-box">
                    <strong>ℹ️ Nota:</strong> Solo necesitas configurar el path aquí. Las credenciales de Mercado Pago
                    (access_token, public_key) se editan desde <strong>"Medios de Pago → Configuración"</strong>.
                </div>

                <button type="submit" name="save_path" class="btn btn-primary">
                    💾 Guardar Path
                </button>
                <a href="/admin/config-payment.php" class="btn btn-secondary">
