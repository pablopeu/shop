...
<body>
    ...
    <div class="main-content">
        <div class="content-header">
            ...
            <a href="<?php echo url('/admin/ventas.php'); ?>" class="btn btn-secondary">← Volver a Ventas</a>
        </div>
        ...
        <form method="POST" action="" onsubmit="return confirm('¿Está seguro que desea reprocesar este pago?');">
