                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="actions">
                                            ...
                                            <a href="javascript:void(0)" class="btn btn-danger btn-sm" onclick="confirmArchivePromotion('<?php echo urlencode($promo['id']); ?>', '<?php echo htmlspecialchars($promo['name'], ENT_QUOTES); ?>')">📦 Archivar</a>
                                        </div>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
